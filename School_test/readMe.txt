...
（直接连接我的或者自己启用hub；http://192.168.0.127:4444/grid/console）
...
启用node：另打开cmd-到 selenium-server-standalone-3.141.59.jar 目录下，输入命令：java -jar selenium-server-standalone-3.141.59.jar -role node -port 5555 -hub http://localhost:4444/gird/register                                        
